...
def main():
  ...
  # Temporary variables
  tempBucket = stackName.lower() + "-temp-" + str(uuid.uuid4())
    ...
    Parameters=[
      {
        ...
        'ParameterValue': cfg['ingest_bucket'] + "-" + str(uuid.uuid4())
      }
    ],
    # We need to explicitly acknowledge that we are creating IAM roles
    Capabilities=[
      'CAPABILITY_IAM'
    ],
  )
